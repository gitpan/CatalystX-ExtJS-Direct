...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::VERSION = '2.1.2';
}
...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::Chained::VERSION = '2.1.2';
}
use Moose::Role;
...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::REST::VERSION = '2.1.2';
}
use Moose::Role;
...
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::REST::ExtJS::VERSION = '2.1.2';
}
use Moose::Role;

package CatalystX::Controller::ExtJS::Direct::Route::Factory;
BEGIN {
  $CatalystX::Controller::ExtJS::Direct::Route::Factory::VERSION = '2.1.2';
}
